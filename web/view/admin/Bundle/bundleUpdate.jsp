...
label{
    left: 0px;
          ...
          <form action="bundleUpdateController" method="POST">
                    <% Bundle u = (Bundle) request.getAttribute("bundle"); %>
                    <input type="text" name="bundleID" value="<%=(u.getBundleID())%>" required="" readonly=""/>
                    <input type="text" name="fullName" value="<%=(u.getBundleName())%>" required="" readonly=""/>
                    <input type="text" name="price" value="<%=(u.getPrice())%>" required=""/>
