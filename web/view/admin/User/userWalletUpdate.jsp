...
label{
    left: 0px;
             ...
             <div id="page-wrapper" >
            <div id="page-inner">
                <form action="UserWalletUpdateController" method="POST">
                    <% Users u = (Users) request.getAttribute("user"); %>
                    <input type="text" name="email" value="<%=(u.getEmail())%>" required="" readonly=""/>
                    <input type="text" name="fullName" value="<%=(u.getFullName())%>" required="" readonly=""/>
                    <input type="text" name="wallet" value="<%=(u.getWallet())%>" required=""/>
